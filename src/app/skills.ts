...
const skills: Skills[] = [
  ...
  { name: "jQuery", proficiency: 4, action: "none" },
  { name: "Python", proficiency: 4, action: "none" },
  { name: "SQL", proficiency: 4, action: "none" },
  { name: "Swift", proficiency: 3, action: "none" },
  { name: "iOS Development", proficiency: 3, action: "none" },
  { name: "Kotlin", proficiency: 3, action: "none" },
  { name: "Android Development", proficiency: 3, action: "none" },
  { name: "MongoDB", proficiency: 3, action: "none" },
  { name: "C++", proficiency: 3, action: "none" },
  { name: "Mathematica", proficiency: 2, action: "none" },
  { name: "Lua", proficiency: 1, action: "none" },
